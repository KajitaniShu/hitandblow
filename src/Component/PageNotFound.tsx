  ...
  return (
    ...
    <Container className={classes.root} p={"lg"}>
      <SimpleGrid spacing={80} cols={2} breakpoints={[{ maxWidth: 'sm', cols: 1, spacing: 40 }]}>
        <Box maw={240} mx="auto" className={classes.mobileImage} >
          <Image  src={'images/pagenotfound.png'} />
        </Box>
        <div>
        ...
        <Image src={'images/pagenotfound.png'} height={200} withPlaceholder className={classes.desktopImage} />
      </SimpleGrid>
    </Container>
    </Center>
  );
